...
import com.zhaw.catiejo.whatsforlunch._campusinfo.helper.CateringDatabaseHelper;
import com.zhaw.catiejo.whatsforlunch._campusinfo.helper.ArrayUtils;
...
public final class CateringContentProvider extends ContentProvider {
     ...
     * {@link com.zhaw.catiejo.whatsforlunch._campusinfo.dao.GastronomicFacilityDao} objects. Contains
    ...
    /**
     * Meta data for the table that stores
     * {@link com.zhaw.catiejo.whatsforlunch._campusinfo.dao.HolidayDao} objects. Contains
     * constants that hold the name of the table and columns.
     */
    ...
    /**
     * Meta data for the table that stores
     * {@link com.zhaw.catiejo.whatsforlunch._campusinfo.dao.ServiceTimePeriodDao} objects. Contains
     * constants that hold the name of the table and columns.
     */
    ...
    /**
     * Meta data for the table that stores
     * {@link com.zhaw.catiejo.whatsforlunch._campusinfo.dao.DishDao} objects. Contains
     * constants that hold the name of the table and columns.
     */
