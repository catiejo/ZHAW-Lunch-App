package ch.zhaw.init.android.campusinfo.service.remote;

import android.content.Context;
import android.util.Log;
import ch.zhaw.init.android.campusinfo.R;
import ch.zhaw.init.android.campusinfo.service.remote.dto.catering.GastronomicFacilityListDto;
import ch.zhaw.init.android.campusinfo.service.remote.dto.catering.MenuPlanListDto;
import ch.zhaw.init.android.campusinfo.util.HockeyAppUtil;
import ch.zhaw.init.android.campusinfo.util.retrofit.IRetrofitProxyFactory;
import ch.zhaw.init.android.campusinfo.util.retrofit.JacksonConverter;
...
import static ch.zhaw.init.android.campusinfo.service.remote.CateringRemoteFacadeResult.Outcome;
